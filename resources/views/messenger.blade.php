...
<body>
                                        ...
                                        <div class="row align-items-center gx-5">
                                            <div class="col-auto">
                                                <div class="avatar avatar-online d-none d-xl-inline-block">
                                                    <img class="avatar-img" id="chat-avatar" src=""
                                                        alt="">
                                                </div>
                                            </div>
                    ...
                    <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
                        ...
                        <form class="chat-form rounded-pill bg-dark" data-emoji-form="" method="post" action="{{route('api.messages.store')}}">
                            ...
                            <div class="row align-items-center gx-0">
                                ...
                                <div class="col">
                                    <div class="input-group">
                                        <textarea class="form-control px-0" name="message" placeholder="Type your message..." rows="1" data-emoji-input=""
    ...
    <script>
        ...
        var pusher = new Pusher('5af6692bee91388e3df3', {
          cluster: 'ap2',
