...
<!--                                if type of message is file-->
                                ...
                                <div class="message-action">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center text-danger" href="#" @click.prevent="$root.deleteMessage(message)" >
                        ...
                        <div class="message-footer">
                            <span class="extra-small text-muted">{{ $root.moment(
                                message.created_at
                            ) }}</span>
                        </div>
                    </div>
    ...
    updated() {
        if (this.conversation && this.fetch != this.conversation.id) {
            fetch(`/api/conversations/${this.conversation.id}/messages`)
                ...
                .then(json => {
                    this.$root.messages = json.messages.data.reverse();
                    this.fetch = this.conversation.id;
                    let container = document.getElementById("#chat-body");
                    container.scrollTop = container.scrollHeight;
                })
        }
